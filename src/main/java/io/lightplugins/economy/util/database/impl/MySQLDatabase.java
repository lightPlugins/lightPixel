package io.lightplugins.economy.util.database.impl;

import com.zaxxer.hikari.HikariConfig;
import com.zaxxer.hikari.HikariDataSource;
import io.lightplugins.economy.LightEconomy;
import io.lightplugins.economy.util.database.PooledDatabase;
...
public class MySQLDatabase extends PooledDatabase {
    ...
    public MySQLDatabase(LightEconomy parent, DatabaseCredentials credentials, ConnectionProperties connectionProperties) {
        super(parent);
