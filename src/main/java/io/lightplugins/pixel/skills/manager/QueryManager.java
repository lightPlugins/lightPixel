package io.lightplugins.pixel.skills.manager;
...
public class QueryManager {
    ...
    private final String tableName = "light_skills";
    ...
    public CompletableFuture<Boolean> prepareNewAccount(UUID uuid, boolean withStartBalance) {
        BigDecimal startBalance = LightSkills.instance.getSettingParams().defaultCurrency().getStartBalance();
