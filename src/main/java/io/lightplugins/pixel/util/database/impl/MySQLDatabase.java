package io.lightplugins.pixel.util.database.impl;

import com.zaxxer.hikari.HikariConfig;
import com.zaxxer.hikari.HikariDataSource;
import io.lightplugins.pixel.Light;
import io.lightplugins.pixel.util.database.PooledDatabase;
...
public class MySQLDatabase extends PooledDatabase {
    ...
    public MySQLDatabase(Light parent, DatabaseCredentials credentials, ConnectionProperties connectionProperties) {
        super(parent);
